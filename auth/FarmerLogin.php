...
<head>
    ...
    <title>Farmer Login | FARM SYNC</title>
...
<body>
    <div class="split-container">
        ...
        <div class="left-section">
            ...
            <i class="floating fas fa-tractor" style="top:20%; right:15%; font-size: 2.5rem; animation-delay: 2s;"></i>
            <i class="floating fas fa-seedling" style="bottom:15%; left:15%; font-size: 3rem; animation-delay: 4s;"></i>
            <i class="floating fas fa-wheat" style="bottom:25%; right:20%; font-size: 2.5rem; animation-delay: 6s;"></i>
            
            <h1 class="welcome-text">Grow Your Business With Us</h1>
            <p class="tagline">Connect directly with buyers and get fair prices for your produce</p>
            <i class="farmer-icon fas fa-user-tie"></i>
            
            <div class="features">
                <div class="feature-item">
                    <div class="feature-icon"><i class="fas fa-users"></i></div>
                    <div>Direct Buyers</div>
                </div>
                <div class="feature-item">
        ...
        <div class="right-section">
            ...
            <i class="form-floating fas fa-tractor" style="top:15%; left:15%; animation-delay: 1s;"></i>
            <i class="form-floating fas fa-seedling" style="top:25%; right:20%; animation-delay: 3s;"></i>
            
            <div class="login-card card">
                <div class="card-header">
                    <h4 class="mb-0"><i class="fas fa-sign-in-alt mr-2"></i>FARMER LOGIN</h4>
                </div>
                <div class="card-body">
                    <form name="my-form" action="FarmerLogin.php" method="post">
                        ...
                        <a href="FarmerForgotPassword.php" class="forgot-password mt-3">
                            <i class="fas fa-key mr-1"></i>Forgot your password?
                        </a>
                        <a href="FarmerRegister.php" class="create-account mt-2">
