...
<head>
    ...
    <title>Farmer - Insert or Edit Product</title>
    <style>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form name="my-form" action="InsertProduct.php" method="post" enctype="multipart/form-data">
                                    <!-- Hidden field for product ID (used in case of editing) -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="full_name" class="form-control" name="product_title" value="<?php echo isset($product_title) ? $product_title : ''; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="full_name" class="form-control" name="product_stock" value="<?php echo isset($product_stock) ? $product_stock : ''; ?>" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <select name="product_cat" required>
                                                ...
                                                while ($row_cats = mysqli_fetch_array($run_cats)) {
                                                    ...
                                                    echo "<option value='$cat_id' " . ($product_cat == $cat_id ? 'selected' : '') . ">$cat_title</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="phone_number" class="form-control" name="product_type" value="<?php echo isset($product_type) ? $product_type : ''; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="present_address" class="form-control" type="date" name="product_expiry" value="<?php echo isset($product_expiry) ? $product_expiry : ''; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="nid_number" class="form-control" name="product_price" value="<?php echo isset($product_price) ? $product_price : ''; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <textarea name="product_desc" id="nid_number2" class="form-control" rows="3" required><?php echo isset($product_desc) ? $product_desc : ''; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="nid_number3" class="form-control" name="product_keywords" value="<?php echo isset($product_keywords) ? $product_keywords : ''; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="radio" id="nid_number4" name="product_delivery" value="yes" <?php echo (isset($product_delivery) && $product_delivery == 'yes') ? 'checked' : ''; ?> />Yes
                                            <input type="radio" id="nid_number4" name="product_delivery" value="no" <?php echo (isset($product_delivery) && $product_delivery == 'no') ? 'checked' : ''; ?> />No
                                        </div>
                                    </div>

                                    <div class="col-md-6 offset-md-4">
                                        <button type="submit" class="btn btn-primary" name="insert_pro">
                                            <?php echo isset($product_id) ? 'Update' : 'Insert'; ?>
                                        </button>
                                    </div>
                                </form>
                            </div>
